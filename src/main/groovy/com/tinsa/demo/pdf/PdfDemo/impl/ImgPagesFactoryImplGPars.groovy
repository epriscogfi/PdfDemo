...
class ImgPagesFactoryImplGPars extends PagesFactoryAbst{
    ...
    List<PdfPage> build(){
        ...
        ParallelEnhancer.enhanceInstance(listaImgsPaginada)

        listaImgsPaginada.eachParallel {listaImages ->
            //
...
//        List<PdfPage> pdfPageListAux = listaImgsPaginada.parallelStream().map { listaImages ->
//
//            //
//            long startPage = System.nanoTime()
//            //
